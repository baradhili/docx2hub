...
<!-- Beta Version 070708 
     ...
     taken from http://www.tei-c.org/release/xml/tei/stylesheet/docx/utils/maths/omml2mml.xsl
     modifications: mode = omml2mml introduced
                    default templates raise warnings
                    xmlns removed
                    added namespace mml to all elements
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:variable name="sOperators" select="concat( 
                                                  '&#x21;',
                                                  '&#x22;',
                                                  '&#x23;',
                                                  '&#x26;',
  ...
  <xsl:template match="m:borderBox" mode="omml2mml">

    <!-- Get Lowercase versions of properties -->
    <xsl:variable name="sLowerCaseHideTop"    select="translate(m:borderBoxPr[last()]/m:hideTop[last()]/@m:val,    $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseHideBot"    select="translate(m:borderBoxPr[last()]/m:hideBot[last()]/@m:val,    $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseHideLeft"   select="translate(m:borderBoxPr[last()]/m:hideLeft[last()]/@m:val,   $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseHideRight"  select="translate(m:borderBoxPr[last()]/m:hideRight[last()]/@m:val,  $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeH"    select="translate(m:borderBoxPr[last()]/m:strikeH[last()]/@m:val,    $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeV"    select="translate(m:borderBoxPr[last()]/m:strikeV[last()]/@m:val,    $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeBLTR" select="translate(m:borderBoxPr[last()]/m:strikeBLTR[last()]/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseStrikeTLBR" select="translate(m:borderBoxPr[last()]/m:strikeTLBR[last()]/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
  ...
  <xsl:template match="m:m" mode="omml2mml">
    <mml:mtable>
      <xsl:call-template name="CreateMathMLMatrixAttr">
        <xsl:with-param name="mcJc" select="string-join(m:mPr/m:mcs/m:mc/m:mcPr/m:mcJc/@m:val,' ')"/>
  ...
  <xsl:template name="CreateMathMLMatrixAttr">
    ...
    <xsl:if test="$sLowerCaseMcjc">
      <xsl:attribute name="columnalign" select="$sLowerCaseMcjc"/>
    </xsl:if>
    <xsl:if test="$rSp!=''">
  ...
  <xsl:template match="m:phant" mode="omml2mml">
    <xsl:variable name="sLowerCaseZeroWidVal"
      select="translate(m:phantPr[last()]/m:zeroWid[last()]/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseZeroAscVal"
      select="translate(m:phantPr[last()]/m:zeroAsc[last()]/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseZeroDescVal"
      select="translate(m:phantPr[last()]/m:zeroDesc[last()]/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:variable name="sLowerCaseShowVal"
      select="translate(m:phantPr[last()]/m:show[last()]/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
    ...
    <xsl:choose>
      ...
      <xsl:when test="$fShow = 1">
        <xsl:element name="mpadded">
          ...
          <mml:mrow>
            <xsl:apply-templates select="m:e" mode="omml2mml"/>
          </mml:mrow>
        </xsl:element>
      </xsl:when>
  ...
  <xsl:template match="m:rad" mode="omml2mml">
    <xsl:variable name="sLowerCaseDegHide"
      select="translate(m:radPr[last()]/m:degHide/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:choose>
      ...
      <xsl:otherwise>
        <mml:mroot>
          ...
          <mml:mrow>
            <xsl:apply-templates select="m:deg[1]" mode="omml2mml"/>
          </mml:mrow>
        </mml:mroot>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template match="m:limLow" mode="omml2mml">
    <mml:munder>
      ...
      <mml:mrow>
        <xsl:apply-templates select="m:lim[1]" mode="omml2mml"/>
      </mml:mrow>
    </mml:munder>
  </xsl:template>

  <xsl:template match="m:limUpp" mode="omml2mml">
    <mml:mover>
      <mml:mrow>
        <xsl:apply-templates select="m:e[1]" mode="omml2mml"/>
      </mml:mrow>
  ...
  <xsl:template match="m:sSub" mode="omml2mml">
    <mml:msub>
      <mml:mrow>
        <xsl:apply-templates select="m:e[1]" mode="omml2mml"/>
      </mml:mrow>
  ...
  <xsl:template match="m:sSup" mode="omml2mml">
    <mml:msup>
      <mml:mrow>
        <xsl:apply-templates select="m:e[1]" mode="omml2mml"/>
      </mml:mrow>
  ...
  <xsl:template match="m:sSubSup" mode="omml2mml">
    <mml:msubsup>
      <mml:mrow>
        <xsl:apply-templates select="m:e[1]" mode="omml2mml"/>
      </mml:mrow>
  ...
  <xsl:template match="m:func" mode="omml2mml">
    <mml:mrow>
      <mml:mrow>
  ...
  <!-- %%Template: match m:f 
	...
	-->
  <xsl:template match="m:f" mode="omml2mml">
    <xsl:variable name="sLowerCaseType"
      select="translate(m:fPr[last()]/m:type/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
    <xsl:choose>
      <xsl:when test="$sLowerCaseType='lin'">
        <mml:mrow>
          <mml:mrow>
            <xsl:apply-templates select="m:num[1]" mode="omml2mml"/>
          </mml:mrow>
          <mml:mo>/</mml:mo>
          <mml:mrow>
            <xsl:apply-templates select="m:den[1]" mode="omml2mml"/>
          </mml:mrow>
        </mml:mrow>
      </xsl:when>
      <xsl:otherwise>
  ...
  <xsl:template name="CreateMathMLFracProp">
    <xsl:param name="type"/>
    <xsl:variable name="sLowerCaseType" select="translate($type, $alpha-uppercase, $alpha-lowercase)"/>
  ...
  <xsl:template match="m:bar" mode="omml2mml">
    <xsl:variable name="sLowerCasePos" select="translate(m:barPr/m:pos/@m:val, $alpha-uppercase, $alpha-lowercase)"/>
  ...
  <!-- %%Template match m:d
		...
		Process a delimiter. 
	-->
  <xsl:template match="m:d" mode="omml2mml">
    <mml:mfenced>
  ...
  <xsl:template name="m:preliminary-mtext1">
  ...
  <xsl:template match="m:r" mode="omml2mml">
    <!-- Typical content: m:t or w:sym. 
         In rare cases (for ex., when an OMML formula contained a MathType object that was converted 
         to OMML), m:r may contain the whole wealth of OMML, such as m:sSub. This seems to be legit
         in docx.
    -->
    ...
    <xsl:choose>
      <xsl:when test="$strike-through or $border">
        <mml:menclose>
          <xsl:attribute name="notation" 
                         select="'horizontalstrike'[$strike-through], 'box'[$border]"/>
          <xsl:choose>
  ...
  <xsl:template match="m:eqArr" mode="omml2mml">
    <mml:mtable>
      <xsl:for-each select="m:e">
        <mml:mtr>
          <mml:mtd>
            <xsl:choose>
              <xsl:when
                test="m:argPr[last()]/m:scrLvl/@m:val!='0' or                   not(m:argPr[last()]/m:scrLvl/@m:val)  or                   m:argPr[last()]/m:scrLvl/@m:val=''">
                <mml:mrow>
                  <mml:maligngroup/>
  ...
  <xsl:template name="CreateEqArrRow">
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        <xsl:apply-templates select="$ndCur" mode="omml2mml"/>
      </xsl:otherwise>
    </xsl:choose>
  ...
  <xsl:template name="CountAmp">
    ...
    <xsl:choose>
      <xsl:when
        test="string-length(substring-after($sAllMt, '&amp;')) &gt; 0 or                     substring($sAllMt, string-length($sAllMt))='&amp;'">
        <xsl:call-template name="CountAmp">
        ...
        <xsl:when test="$fOperAtPos1='1'">
          ...
          <mml:mo>
            <xsl:if test="$context/w:rPr/w:color/@w:val or $context/w:rPr/w:rStyle/@w:val">
              <xsl:sequence select=" mml:get-color($context/w:rPr/w:color/@w:val, $context/w:rPr/w:rStyle/@w:val)"/>
            </xsl:if>
            <xsl:if test="$context/w:rPr/(w:highlight/@w:val, w:shd/@w:fill)[1] or $context/w:rPr/w:rStyle/@w:val">
              <xsl:sequence select="mml:get-background-color($context/w:rPr/(w:highlight/@w:val, w:shd/@w:fill)[1],
  ...
  <xsl:template name="checkDirectFormatting">
    ...
    <xsl:if test="w:rPr/w:color/@w:val or w:rPr/w:rStyle/@w:val">
      <xsl:sequence select="mml:get-color(w:rPr/w:color/@w:val, w:rPr/w:rStyle/@w:val)"/>
    </xsl:if>
    <xsl:if test="w:rPr/(w:highlight/@w:val, w:shd/@w:fill)[1] or w:rPr/w:rStyle/@w:val">
      <xsl:sequence select="mml:get-background-color(w:rPr/(w:highlight/@w:val, w:shd/@w:fill)[1],
  ...
  <xsl:template match="m:ctrlPr" mode="omml2mml">
    <!-- ignore properties on control characters (e.g. bar of fraction) -->
  </xsl:template>

  <xsl:template match="m:box" mode="omml2mml">
    <!-- Math box ... -->
    <xsl:apply-templates mode="#current"/>
  </xsl:template>

  <xsl:template match="m:boxPr" mode="omml2mml">
    <!-- Math box properties ignored -->
  </xsl:template>

  <xsl:template match="m:argPr" mode="omml2mml">
  ...
  <xsl:template match="m:oMath" mode="omml2mml">
    <mml:math>
      <xsl:attribute name="display" select="if (ancestor::m:oMathPara) then 'block' else 'inline'"/>
  ...
  <xsl:template match="m:t/text()[matches(., $omml-character-correction-regex)]" mode="wml-to-dbk">
